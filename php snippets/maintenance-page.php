...
<body>
    <div class="maintenance">
      <div class="maintenance_contain">
        ...
        <span class="pp-infobox-title-prefix">Мы скоро вернемся</span>
        <div class="pp-infobox-title-wrapper">
              <h3 class="pp-infobox-title">Сайт на техническом обслуживниее</h3>
          </div> 
      <div class="pp-infobox-description">
            <p></p>			</div>    
        <span class="title-text pp-primary-title">Вы можете позвонить нам по телефону или написать на нашу почту</span>
    </div>
      </div>
    </div>
</body>
